...
UTILS_SRC    = utils/ft_strndup.c utils/ft_is_whitespace.c utils/ft_extender.c utils/ft_dequoter.c utils/ft_strsjoin.c utils/ft_strscomp.c utils/ft_shllvl.c
